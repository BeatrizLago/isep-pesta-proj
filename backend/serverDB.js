...
const initialData = [
  ...
  createPlace({
    ...
    signLanguage: false,
    writtenDescriptions: true,
    wheelchairWidth: "not available",
    wheelchairHeight: "not available",
    latitude: "41.13842367518304",
    longitude: "-8.607536667166048",
    siteURL: "https://culturanorte.gov.pt/patrimonio/mosteiro-da-serra-do-pilar/",
    imageURL:
  ...
  createPlace({
    ...
    imageURL:
      "https://parquebiologico.pt/images/ParqueBiologico/parque.jpg",
